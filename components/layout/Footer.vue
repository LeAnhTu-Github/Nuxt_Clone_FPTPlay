    ...
    <footer class="bg-black text-white pt-8 pb-4">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
                ...
                <div class="flex flex-col gap-4 md:w-1/4">
                    <div class="flex items-center gap-2">
                        <img src="/images/logo.png" alt="FPT Play" class="h-10" />
                    </div>
                    <img src="/images/badge-bocongthuong.png" alt="Bộ Công Thương" class="h-8 w-1/2" />
                    <img src="/images/dmca-protected.png" alt="DMCA Protected" class="h-8 w-1/2" />
                </div>
                <!-- Về FPT Play -->
                <div class="flex flex-col gap-2 md:w-1/6 text-sm">
                    <span class="font-semibold mb-2">Về FPT Play</span>
                    <a href="#" class="hover:underline">Giới thiệu</a>
                    <a href="#" class="hover:underline">Các gói dịch vụ</a>
                ...
                <div class="flex flex-col gap-2 md:w-1/4">
                    <div class="flex items-center gap-2">
                        <svg data-v-fc05d500="" viewBox="0 0 16 16" width="0.8em" height="0.8em" focusable="false"
                            role="img" aria-label="telephone" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="bi-telephone b-icon bi" style="margin-right: 5px; font-size: 140%;">
                            <g data-v-fc05d500="">
                                <path
                    ...
                    <div class="flex items-center gap-2">
                        <svg data-v-fc05d500="" viewBox="0 0 16 16" width="0.8em" height="0.8em" focusable="false"
                            role="img" aria-label="envelope" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="bi-envelope b-icon bi" style="margin-right: 5px; font-size: 140%;">
                            <g data-v-fc05d500="">
                                <path
                    ...
                    <span class="mt-2">Theo dõi chúng tôi trên:</span>
                    <div class="flex gap-3 mt-1">
                        <a href="#" aria-label="Facebook" tabindex="0">
                            <svg class="w-6 h-6 text-white hover:text-orange-500" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#" aria-label="YouTube" tabindex="0">
                            <svg class="w-6 h-6 text-white hover:text-orange-500" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                                    d="M21.8 8.001a2.75 2.75 0 00-1.94-1.94C18.08 6 12 6 12 6s-6.08 0-7.86.061a2.75 2.75 0 00-1.94 1.94C2 9.78 2 12 2 12s0 2.22.2 3.999a2.75 2.75 0 001.94 1.94C5.92 18 12 18 12 18s6.08 0 7.86-.061a2.75 2.75 0 001.94-1.94C22 14.22 22 12 22 12s0-2.22-.2-3.999zM10 15.5v-7l6 3.5-6 3.5z">
                                </path>
                            </svg>
                        </a>
                    </div>
            ...
            <div class="text-xs text-gray-300 space-y-2 flex gap-2 justify-between">
                <div class="w-3/4">
                    <div class="text-xs">
                        Công ty Cổ phần Viễn Thông FPT - Người đại diện: Ông Hoàng Việt Anh. Trụ sở: Tầng 2, Tòa nhà FPT
                        Cầu Giấy, Số 17 Phố Duy Tân, Phường Dịch Vọng Hậu, Quận Cầu Giấy, TP.Hà Nội<br>
                        Địa chỉ liên lạc: Tầng 9, Block A, tòa nhà FPT Cầu Giấy, số 10 Phạm Văn Bạch, quận Cầu Giấy, TP.
                        Hà Nội<br>
                        Số điện thoại liên hệ: 024 7300 2222. Thư điện tử: hotrokhachhang@fpt.com hoặc
                        hotrofptplay@fpt.com
                    </div>
                    <div class="text-xs mt-4">
                        Giấy chứng nhận đăng ký doanh nghiệp số 0101778163 do Sở Kế hoạch và Đầu tư Thành phố Hà Nội cấp
                        lần đầu ngày 28/7/2005, cấp đăng ký thay đổi lần thứ 32 vào ngày 21/12/2023.<br>
                        Giấy phép cung cấp dịch vụ phát thanh, truyền hình trả tiền số 377/GP-BTTTT cấp sửa đổi bổ sung
                ...
                <div class="flex gap-4 mt-2 w-1/4 pl-10">
                    ...
                    <img src="/images/icon-web.png" alt="Web" class="h-5" />
                    <img src="/images/icon-apple.png" alt="Apple" class="h-5" />
